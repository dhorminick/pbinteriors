...
<html lang="en">
  <head>
    ...
    <title>What We Do | PbInteriors</title>
     <!-- web fonts -->
          ...
          <div class="heading text-center mx-auto mb-5 custom">
            ...
            <div class="cwp4-two row">
                <div class="cwp4-text col-lg-6">
                    ...
                    <a class="btn btn-secondary btn-theme3 mt-3" href="/projects/all-interiors"> View Our Interiors <i class="fa fa-arrow-right"></i></a>
                </div>
                <div class="cwp4-image col-lg-6 pl-lg-5 mt-lg-0 mt-5 showBg">
          ...
          <div class="heading text-center mx-auto mb-5 custom">
            ...
            <div class="cwp4-two row">
                ...
                <div class="cwp4-text col-lg-6 pl-lg-5 mt-lg-0 mt-5">
                    ...
                    <a class="btn btn-secondary btn-theme3 mt-3" href="/projects/all-apartments"> View Our Apartments <i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
