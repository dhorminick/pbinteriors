...
<html lang="en">
  <head>
    ...
    <title>View All Apartments Available For Rent | PbInteriors</title>
     <!-- web fonts -->
...
<?php
    $AllApartments = "SELECT * FROM apartment WHERE apartment_status = 'rent'";
        ...
        <div id="products4-block" class="text-center">
            <div class="container">
                <div class="heading text-center mx-auto">
                    <h3 class="head">Available Apartments For Rent</h3>
