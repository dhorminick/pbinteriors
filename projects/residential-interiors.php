...
<html lang="en">
  <head>
    ...
    <title>Residential Interior Designs | PbInteriors</title>
     <!-- web fonts -->
...
<section class="w3l-index6" id="about">
  <div class="features-with-17_sur">
    ...
    <div class="heading text-center mx-auto"  style="margin-top: 90px !important;">
      <h3 class="head">Residential Interiors</h3>
      <p class="my-3 head">Building deeply personal spaces that reflect your interior design style.</p><hr>
    </div>
...
<?php
    $ResidentialInteriors = "SELECT * FROM portfolio";
    $ResidentialInteriorsResult = mysqli_query($con,$ResidentialInteriors);
        if ($ResidentialInteriorsResult->num_rows > 0) {
?>
